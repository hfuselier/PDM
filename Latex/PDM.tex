...
%(needs to be after title-page and front-matter to keep the table of contents lists short)
...
\include{main/ch2_failure_criteria}
\include{main/ch3_dunnville_sandstone}
\include{main/ch4_multi_axial_exp}
\include{main/ch5_results}
