...
\begin{figure}[!]
    ...
    \captionsetup{justification=centering}
    \caption{Stress vs. axial strain plot for the true-triaxial experiment performed under plane strain condition}
    \label{fig4:10}
\end{figure} 
...
\begin{figure}[!]
    ...
    \captionsetup{justification=centering}
    \caption{Transversal strain vs. time plot for true-triaxial experiment under plane strain condition}
    \label{fig4:11}
\end{figure} 
