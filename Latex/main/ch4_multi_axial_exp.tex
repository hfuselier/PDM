...
\begin{figure}[!]
    \centering
    \includegraphics[width=\columnwidth]{ch4/apparatus}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.35\columnwidth]{ch4/specimen}
    \captionsetup{justification=centering}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.3\columnwidth]{ch4/spe_coating}
    \includegraphics[width=0.3\columnwidth]{ch4/coating}
    \captionsetup{justification=centering}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.35\columnwidth]{ch4/ps_setup}
    \captionsetup{justification=centering}
...
\begin{figure}[!]
    \centering
    \includegraphics[width=0.9\columnwidth]{ch4/stressvsstrain_TT1}
    \captionsetup{justification=centering}
...
\begin{figure}[!]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch4/eps2time}
    \captionsetup{justification=centering}
...
Figure \ref{fig4:14} shows the failed specimen from the side perpendicular to the minor stress direction (left), and from the bottom (perpendicular to the axial stress)(right). It presents a failure surface oriented at \ang{66} in the $(\sigma_1-\sigma_{2})$ directional plane, starting from the top right and ending at the bottom middle of the specimen. 


\begin{figure}[!]
    \centering
    \includegraphics[width=0.5\columnwidth]{ch4/TT2}
    \includegraphics[width=0.3\columnwidth]{ch4/TT2top}
    \captionsetup{justification=centering}
