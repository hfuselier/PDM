...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch2/mc_sig1sig3}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.9\columnwidth]{ch2/mc_pq}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch2/mc_pi}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch2/hb_sig1sig3}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.8\columnwidth]{ch2/hb_pq}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch2/hb_pi}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.75\columnwidth]{ch2/pmc_sig1sig3}
...
Figure 2.3 for Mohr-Coulomb can be used to represent Paul-Mohr-Coulomb if $m_{c,e}$ and $b_{c,e}$ are used.
