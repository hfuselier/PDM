...
The complete graphical representation of the Paul-Mohr-Coulomb failure surface is composed of the $(p-q)$ plane, the $(\sigma_2-\sigma_1)$ plane, the $\pi$-plane and the principal stresses three-dimensional space. The transition between $P2$ and $P1$ is best presented in the $(p-q)$ plane, where they intersect on the compression side (i.e. $q > 0$) at the mean stress value $p_c$ and on the extension side (i.e. $q < 0$) at $p_e$. A sketch of the 6-12-6 sided failure surface in the $(p-q)$ plane is presented in Figure \ref{fig5:6pmc_pq} and schematic representations as well as more details on the four failure surfaces types are provided in APPENDIX B REF{APPENDIX B}.

\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{ch5/6pmc_pq}
    \caption{Paul-Mohr-Coulomb 6-12-6 sided failure surface in $(p-q)$ plane}
    \label{fig5:6pmc_pq}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{ch5/6pmc_sig2sig1}
...
. The fitting procedure presented in 4.3.1. should then be applied to the two set of data points, resulting in different values of $\phi_c$,$\phi_e$ and $V_0$ for each plane.
