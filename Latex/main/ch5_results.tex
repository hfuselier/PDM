...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.8\columnwidth]{ch5/pmc3p_pq}
    \caption{Paul-Mohr-Coulomb criterion failure surface in $(p-q)$ plane}
    \label{fig5:pmc_pq}
\end{figure} 

Finally, the Paul-Mohr-Coulomb criterion is presented in the $\pi$-plane, obtained following the procedure described in Section \ref{ch2:PMC}. Figure \ref{fig5:pmc_pi_plane} shows Paul-Mohr-Coulomb failure criterion in the $\pi$-plane at different values of the mean stress $p$.

\begin{figure}[tb]
    \centering
    \includegraphics[width=0.5\columnwidth]{ch5/pmc3p_pi_pts1}
    \includegraphics[width=0.9\columnwidth]{ch5/pmc3p_pi_pts2}
