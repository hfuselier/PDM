...
\begin{table}
    ...
    \begin{tabular}{cccccccc}
        \hline 
        Test & Bedding orientation & $\sigma_1$ [\si{MPA}] & $\sigma_2$ [\si{MPA}] &$\sigma_3$ [\si{MPA}] & $p$ [\si{MPA}] & $q$ [\si{MPA}] & $\theta$ [\si{\degree}] \\
        \hline
        \hline
        ...
        \hline
    \end{tabular}
    \caption{Database of experiments results for Dunnville Sandstone}
    \label{tb5:database}
\end{table}
