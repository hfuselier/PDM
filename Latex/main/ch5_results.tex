\chapter{Results analysis and Discussion}\label{ch5:chapter5}
...
The mean standard deviation misfit obtained with the Mohr-Coulomb failure criterion is $14.2$ \si{\mega\pascal}. 
...
The mean standard deviation misfit obtained with the Hoek-Brown failure criterion is $13.96$ \si{\mega\pascal}. 
...
\begin{table}
    ...
    \begin{tabular}{ccc}
        ...
        Mohr-Coulomb & 14.2 \\
        Hoek-Brown & 13.9 \\
        Paul-Mohr-Coulomb, 1 plane & 13.2 \\
        \hline
    \end{tabular}
    \label{tb5:stand_dev}
\end{table}
