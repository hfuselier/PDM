...
\section{Experiments results Database }
...
Dunnville Sandstone have been used for several works in the past and particularly for multi axial experiments \cite{Labuz2018}\cite{Zeng2019}\cite{Tarokh2016}. The ones performed in the scope of this study (cf. Chapter \ref{ch4:title}) were the opportunity to enrich the existing tests results database, in order to evaluate the failure criteria with data representative of Dunnville sandstone response.

The database presented in Figure \ref{tb5:database} was based on the one proposed by Zeng et al. (2019) \cite{Zeng2019}, and extended with the results of the experiments from this study. For each test listed, 

\begin{table}
    \centering
    \begin{tabular}{cccccccc}
        \hline 
        Test & Bedding & $\sigma_1$ [\si{MPA}] & $\sigma_2$ [\si{MPA}] &$\sigma_3$ [\si{MPA}] & $p$ [\si{MPA}] & $q$ [\si{MPA}] & $\theta$ [\si{\degree}] \\
        \hline
        \hline
        ...
        \hline
    \end{tabular}
    \caption{Database of experiments results for Dunnville Sandstone. the "Published" data come from Zeng et al. \cite{Zeng2019}}
    \label{tb5:database}
\end{table}

\section{Evaluation of the failure criteria }
\section{Bi-linear Paul-Mohr-Coulomb failure criterion}
